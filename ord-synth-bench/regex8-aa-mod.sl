...
(constraint (Start.Sem match_regex 1 3 1 1 2 1 1 1 false))
(constraint (Start.Sem match_regex 2 1 1 1 3 1 4 1 false))
(constraint (Start.Sem match_regex 2 2 5 5 5 1 1 1 false))
(constraint (Start.Sem match_regex 1 2 3 4 5 1 2 3 false))
(constraint (Start.Sem match_regex 5 4 3 2 1 5 4 3 false))
